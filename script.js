...
async function loadProducts() {
    try {
        ...
        const pat = window.GITHUB_PAT || 'fallback_pat_if_needed'; // Gunakan env var dari Vercel
        const response = await fetch(`https://raw.githubusercontent.com/raishaanajma/xixixoxostore/main/products.json?token=${pat}`);
        if (!response.ok) {
